 ...
 */
public class SkyHopper extends Filterable {
    // Settings
    private int version;
    ...
    /**
     * Constructor.
     * Creates a new SkyHopper using the default SkyHopper config from the plugin's settings.
     * @param settings The plugin's {@link Settings}.
     */
    public SkyHopper(@NotNull Settings settings) {
        super(FilterType.NONE, new ArrayList<>());
        ...
        this.owner = null;
        this.location = null;
        this.transferSpeed = settings.skyHopperConfig().startingTransferSpeed();
        this.maxTransferSpeed = transferSpeed;
        this.transferAmount = settings.skyHopperConfig().startingTransferAmount();
        this.maxTransferAmount = transferAmount;
        this.suctionSpeed = settings.skyHopperConfig().startingSuctionSpeed();
        this.maxSuctionSpeed = suctionSpeed;
        this.suctionAmount = settings.skyHopperConfig().startingSuctionAmount();
        this.maxSuctionAmount = suctionAmount;
        this.suctionRange = settings.skyHopperConfig().startingSuctionRange();
        this.maxSuctionRange = suctionRange;
        this.maxContainers = settings.skyHopperConfig().startingMaxContainers();

        long now = System.currentTimeMillis();
        this.nextSuctionTime = now;
        this.nextTransferTime = now;
    }

    /**
     * Constructor
     * @param version The version of the SkyHopper.
    ...
    /**
     * Set the version of the SkyHopper.
     * @param version The version of the SkyHopper to set.
     */
    ...
    /**
     * Get the version of the SkyHopper.
     * @return The version of the SkyHopper.
     */
    ...
    /**
     * Set whether the SkyHopper is enabled or not.
     * @param enabled Is the SkyHopper enabled or disabled?
     */
    ...
    /**
     * Set whether particles are enabled or not.
     * @param particles Is the SkyHopper's particles enabled or disabled?
     */
     ...
     * @return The maximum number of linked containers allowed.
     */
    ...
    /**
     * Get the next time the SkyHopper should suction items.
     * @return The next time the SkyHopper should suction items.
     */
    ...
    /**
     * Set the next time the SkyHopper should suction items.
     * @param nextSuctionTime The next time the SkyHopper should suction items.
     */
    ...
    /**
     * Get the next time the SkyHopper should transfer items.
     * @return The next time the SkyHopper should transfer items.
     */
    ...
    /**
     * Set the next time the SkyHopper should transfer items.
     * @param nextTransferTime The next time the SkyHopper should transfer items.
     */
