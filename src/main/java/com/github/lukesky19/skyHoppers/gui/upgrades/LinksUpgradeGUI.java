 ...
 */
public class LinksUpgradeGUI extends ChestGUI {
    ...
    public LinksUpgradeGUI(
        ...
        guiConfig = guiManager.getUpgradeConfig("links.yml");
        if(guiConfig == null) {
    ...
    public void update() {
        ...
        TreeMap<Integer, Double> displayUpgrades = settingsManager.getContainerUpgrades();
    ...
    private void createUpgradeButton(@NotNull SkyHopper skyHopper, @NotNull TreeMap<Integer, Double> displayUpgrades) {
        ...
        Optional<Map.Entry<Integer, Double>> displayUpgrade = getNextUpgrade(displayUpgrades, skyHopper.maxContainers());
            ...
            if (upgradeConfig.item().material() != null) {
                ...
                if (material != null) {
                    ...
                    List<TagResolver.Single> lorePlaceholders = List.of(
                            Placeholder.parsed("current", String.valueOf(skyHopper.maxContainers())),
                    ...
                    upgradeBuilder.setAction(inventoryClickEvent -> {
                        ...
                        Optional<Map.Entry<Integer, Double>> optionalUpgrade = getNextUpgrade(upgrades, skyHopper.maxContainers());
                        ...
                        if(plugin.getEconomy().getBalance(player) >= upgradePrice) {
                            if(currentSkyHopper.location() != null && currentSkyHopper.location().getBlock().getState(false) instanceof Hopper hopper) {
                                ...
                                List<TagResolver.Single> placeholders = List.of(
                                        Placeholder.parsed("current", String.valueOf(currentSkyHopper.maxContainers())),
                                        Placeholder.parsed("next", String.valueOf(upgradeAmount)));

                                player.sendMessage(FormatUtil.format(player, locale.prefix() + locale.maxLinksUpgrade(), placeholders));
